...
if __name__ == "__main__":
    ...
    exp_algorithm = "原ELP"  # 算法名称改为ELP
    exp_remark = "k=20*T/T_initial,bin_width=5,后期冻结直方图,t_max = 300,G=2000,getfitness2，修改了bay_flip操作，g_best=5396.6，惩罚指数：1至5,step0-6，最优贪婪"
    exp_number = 30
    is_exp = True
