...
class ELP:
    def __init__(self, env, gbest, T, G=100, t_max=50, k=2.0):
        ...
        self.temperature_floor_action_ids = [10, 2, 0]
        self.valid_actions = [0, 1, 2, 3, 10]
...
if __name__ == "__main__":
    ...
    exp_remark_default = "ELP+DQN(main:0/1/2/3/10-light; elite:10/11-highfreq)"
